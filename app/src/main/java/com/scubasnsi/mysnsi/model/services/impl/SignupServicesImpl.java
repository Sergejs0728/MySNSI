...
public class SignupServicesImpl implements SignupService {
    ...
    private final String TAG = SignupServicesImpl.class.getName();
    private Gson mGson;
    ...
    // signup user
    @Override
    public void signupUser(final ResponseCallBackHandler responseCallBackHandler, SignupDto signupDto) {
        try {
            Call<ResponseDto> call = restApiInterface.signup(signupDto);
