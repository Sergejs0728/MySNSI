...
function getViewerConfiguration() {
    ...
    /*DEFAULT_URL= document.getElementById("aaa").getAttribute("href");//DEFAULT_URL
    alert(DEFAULT_URL);*/
  return {
...
/***/ })
/******/ ]);
function load_pdf_java(url) {


    DEFAULT_URL= url;//document.getElementById("aaa").getAttribute("href");//DEFAULT_URL
